...
export default function VerifyOtpPage() {
  ...
  useEffect(() => {
    ...
    if (cooldownEndStr) {
      ...
      // If no cooldown stored, set it to 0 (button enabled)
      setCooldownSeconds(0);
    }

    // Load expiry end timestamp
    ...
    if (expiryEndStr) {
      ...
      // If no expiry stored, redirect to forgot-password (something went wrong)
      router.push("/forgot-password");
    }
  }, [router]);
